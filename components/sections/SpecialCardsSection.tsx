...
const specialQualities = [
  ...
  {
    title: "Kindness",
    description: "Your compassion touches the lives of everyone around you.",
    year: 2024,
    images: ["2024.jpg", "2024-2.jpg", "2024-3.jpg", "2024-4.jpg"],
  },
  {
    title: "Authenticity",
    description: "You inspire others by being unapologetically yourself.",
    year: 2025,
          ...
          {specialQualities.map((quality, index) => (
            ...
            >
              ...
              >
                ...
                >
                  <p className="text-gray-300 mt-3 mb-4 font-light text-sm leading-relaxed">
                    {quality.description}
                  </p>

                  {quality.images && quality.images.length > 0 && (
                    <div className="mt-4 pt-4 border-t border-gray-700">
                      <p className="text-xs text-gray-400 mb-3 uppercase tracking-wider">
                        Memories from {quality.year}
                      </p>
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                        {quality.images.map((image, imgIndex) => (
                          <motion.div
                            key={imgIndex}
                          ...
                          >
                            <Image
                              src={`/images/${image}`}
                              alt={`${quality.year} memory ${imgIndex + 1}`}
                              width={300}
                              height={300}
